    ...
    <main>
      <vs-tabs v-model="tab">
        <vs-tab vs-label="Builder">
          <div class="con-tab-ejemplo">
            <div class="form-stage">
              <draggable
                class="form-stage__drag"
                :list="newElements"
                v-bind="{ group: 'elements' }"
              >
        ...
        <vs-tab vs-label="Preview">
          <div class="con-tab-ejemplo">
            <div class="form-preview" v-html="liveHtml"></div>
          </div>
        </vs-tab>
        <vs-tab vs-label="Code">
          <div class="con-tab-ejemplo">
            <div class="code-output">
              ...
              <code>
                <pre
                  class="code prettyprint lang-html"
...
export default {
  ...
  methods: {
    ...
    checkTypes: function (el, parent) {
      ...
      if (el.container == true) {
        ...
        if (el.type == "panel") {
          ...
          el.backgroundColor
            ? element.classList.add("bg-" + el.backgroundColor, "text-white")
            : void 0;
        ...
        el.classId
          ? element.setAttribute("id", el.classId)
          : element.setAttribute("id", "element" + el.id);
        el.className
          ? element.setAttribute("name", el.className)
          : element.setAttribute("name", "element" + el.id);
    ...
    createLabel: function (el) {
      ...
      el.classId
        ? label.setAttribute("for", el.classId)
